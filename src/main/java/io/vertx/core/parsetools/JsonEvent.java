...
public interface JsonEvent {
   ...
   * @throws ClassCastException if the value is not an {@code Integer}
   */
  Integer integerValue();

  /**
   * @return the {@code Long} value or {@code null} if the event has no JSON value
   * @throws ClassCastException if the value is not a {@code Long}
   */
  Long longValue();

  /**
   * @return the {@code Float} value or {@code null} if the event has no JSON value
   * @throws ClassCastException if the value is not a {@code Float}
   */
  Float floatValue();

  /**
   * @return the {@code Double} value or {@code null} if the event has no JSON value
   * @throws ClassCastException if the value is not a {@code Double}
   */
  Double doubleValue();
