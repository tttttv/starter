...
public interface DnsClient {
   ...
   * @param name  the name to resolve
   * @param handler  the {@link Handler} to notify with the {@link AsyncResult}.
   *                 The handler will get notified with a {@link List} that contains all the resolved
   *                 {@link java.net.Inet4Address}es. If none was found an empty {@link List} will be used.
   ...
   * @param handler the {@link Handler} to notify with the {@link AsyncResult}.
   *                The handler will get notified with a {@link List} that contains all the resolved
   *                {@link java.net.Inet6Address}es. If none was found an empty {@link List} will be used.
   *                If an error accours it will get failed.
   * @return a reference to this, so the API can be used fluently
   */
  @Fluent
   ...
   *                 {@link List}.  If an error accours it will get failed.
   * @return a reference to this, so the API can be used fluently.
   */
  @Fluent
   ...
   *                 get notified with an empty {@link List}. If an error accours it will get failed.
   * @return a reference to this, so the API can be used fluently.
   */
  @Fluent
