...
/**
 * An interface which allows you to put arbitrary objects into a {@link LocalMap}.
 * <p>
 ...
 * will be able to add it to {@link LocalMap} instances.
 * <p>
 * Mutable object that you want to store in a {@link LocalMap}
